...
class PersonalRecord extends DataClass implements Insertable<PersonalRecord> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, exerciseId, recordType, value, workoutId, achievedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class $UserSettingsTable extends UserSettings
  ...
  static const VerificationMeta _defaultRestTimerSecondsMeta =
      const VerificationMeta('defaultRestTimerSeconds');
  @override
  late final GeneratedColumn<int> defaultRestTimerSeconds =
      GeneratedColumn<int>(
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('default_rest_timer_seconds')) {
      context.handle(
        _defaultRestTimerSecondsMeta,
        defaultRestTimerSeconds.isAcceptableOrUnknown(
          data['default_rest_timer_seconds']!,
          _defaultRestTimerSecondsMeta,
        ),
      );
    }
  ...
  UserSetting map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return UserSetting(
      ...
      defaultRestTimerSeconds: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}default_rest_timer_seconds'],
      )!,
...
class UserSetting extends DataClass implements Insertable<UserSetting> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['default_rest_timer_seconds'] = Variable<int>(defaultRestTimerSeconds);
  ...
  UserSettingsCompanion toCompanion(bool nullToAbsent) {
    return UserSettingsCompanion(
      ...
      defaultRestTimerSeconds: Value(defaultRestTimerSeconds),
  ...
  factory UserSetting.fromJson(
    ...
    return UserSetting(
      ...
      defaultRestTimerSeconds: serializer.fromJson<int>(
        json['defaultRestTimerSeconds'],
      ),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'defaultRestTimerSeconds': serializer.toJson<int>(
        defaultRestTimerSeconds,
      ),
  ...
  UserSetting copyWithCompanion(UserSettingsCompanion data) {
    return UserSetting(
      ...
      unitSystem: data.unitSystem.present
          ...
          : this.unitSystem,
      defaultRestTimerSeconds: data.defaultRestTimerSeconds.present
          ? data.defaultRestTimerSeconds.value
          : this.defaultRestTimerSeconds,
  ...
  String toString() {
    return (StringBuffer('UserSetting(')
          ...
          ..write('defaultRestTimerSeconds: $defaultRestTimerSeconds, ')
  ...
  @override
  int get hashCode =>
      Object.hash(id, unitSystem, defaultRestTimerSeconds, themeMode);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is UserSetting &&
          ...
          other.defaultRestTimerSeconds == this.defaultRestTimerSeconds &&
...
class UserSettingsCompanion extends UpdateCompanion<UserSetting> {
  ...
  final Value<int> defaultRestTimerSeconds;
  final Value<String> themeMode;
  const UserSettingsCompanion({
    this.id = const Value.absent(),
    this.unitSystem = const Value.absent(),
    this.defaultRestTimerSeconds = const Value.absent(),
  ...
  static Insertable<UserSetting> custom({
    ...
    Expression<int>? defaultRestTimerSeconds,
    ...
    return RawValuesInsertable({
      ...
      if (defaultRestTimerSeconds != null)
        'default_rest_timer_seconds': defaultRestTimerSeconds,
  ...
  UserSettingsCompanion copyWith({
    ...
    Value<int>? defaultRestTimerSeconds,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (defaultRestTimerSeconds.present) {
      map['default_rest_timer_seconds'] = Variable<int>(
        defaultRestTimerSeconds.value,
      );
    }
    ...
    $WorkoutTemplatesTable table,
        ...
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback:
              ({workoutTemplateExercisesRefs = false, workoutsRefs = false}) {
                return PrefetchHooks(
                  db: db,
                  explicitlyWatchedTables: [
                    if (workoutTemplateExercisesRefs)
...
class $$UserSettingsTableFilterComposer
  ...
  ColumnFilters<int> get defaultRestTimerSeconds => $composableBuilder(
    column: $table.defaultRestTimerSeconds,
    builder: (column) => ColumnFilters(column),
  );
...
class $$UserSettingsTableOrderingComposer
  ...
  ColumnOrderings<int> get defaultRestTimerSeconds => $composableBuilder(
    column: $table.defaultRestTimerSeconds,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$UserSettingsTableAnnotationComposer
  ...
  GeneratedColumn<int> get defaultRestTimerSeconds => $composableBuilder(
    column: $table.defaultRestTimerSeconds,
    builder: (column) => column,
  );
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<int> defaultRestTimerSeconds = const Value.absent(),
